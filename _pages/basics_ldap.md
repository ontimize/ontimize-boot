...
In the *application.yml* we need to change the ontimize security mode to **ldap** and add the following properties (More information in [this link](/ontimize-boot/v1/basics/autoconfigurators/#ldap)):
