...
import org.ontimize.jee.report.rest.ReportStoreRestController;
...
public class OReportAutoConfigure {
	...
	public IReportStoreService ontimizeReportStoreService() {
		//FileReportStoreEngine engine = new FileReportStoreEngine();
...
//		dbReportStoreEngine.setBasePath(basePath);
